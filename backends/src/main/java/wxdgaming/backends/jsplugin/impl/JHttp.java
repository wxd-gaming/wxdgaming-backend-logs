...
public class JHttp implements IJSPlugin {
    ...
    public String get(String url) {
        return HttpRequestGet.of(url).execute().bodyString();
    }

    public String post(String url, String body) {
        return HttpRequestPost.of(url, body).execute().bodyString();
    }

    public String postJson(String url, String json) {
        return HttpRequestPost.ofJson(url, json).execute().bodyString();
    }
